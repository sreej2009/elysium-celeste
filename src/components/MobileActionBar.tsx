...
export default function MobileActionBar() {
  ...
  return (
    <div className="mobile-action-bar" role="group" aria-label="Quick contact">
      <button className="mobile-action-btn is-enquire" onClick={openModal}>
        Enquire
      </button>
      <a
        className="mobile-action-btn is-whatsapp"
        href={whatsappHref}
        target="_blank"
        rel="noopener noreferrer"
      >
        <svg viewBox="0 0 24 24" aria-hidden="true" className="mobile-action-icon">
          <path
            fill="currentColor"
